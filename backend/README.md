...
## Project Structure
    ...
    ├── se_branded_customer_44037  # Django project configurations
...
1. Clone this repo and `cd se_branded_customer_44037`
...
2. Clone this repo and `cd se_branded_customer_44037`
